...
def main() -> None:
    ...
    prediction_path = base_dir / "data" / "predictions" / "predictions_3kelas_checkpoint_2026-04-06.csv"
    eval_summary_path = base_dir / "logs" / "evaluation_summary_3kelas_checkpoint_2026-04-06.json"
    ...
    with col_info3:
        st.caption("🤖 Model: IndoBERT (Fine-tuned untuk Sentimen 3-kelas, checkpoint 2026-04-06)")
